    ...
    <div className={"skillsWrapper"} id="Skills">
      <div className="skillsContent">
        ...
        <div className={"icon-holder"}>
          ...
          <div className={"skill-category deployment"}>
            <div className={"label-holder"}>
              <span>Dev Ops</span>
            </div>
            <motion.div
